                            ...
                            <div class="col-md-12 mb-lg-0 mb-4">
                                <div class="row">
                                    <div class="col-6 text-end">
                                        <a class="btn bg-gradient-dark mb-0" href="/admstr/add-promotion">
                            ...
                            <div class="card-body px-0 pt-0 pb-2">
                                <div class="table-responsive p-0">
                                    <table class="table align-items-center mb-0">
                                        ...
                                        <tbody>
                                            <tr v-for="newsData in news" :key="newsData.id" :id="newsData.id">
                                                ...
                                                <td class="align-middle">
                                                    <a v-bind:href="'/admstr/detail-promotion/' + newsData.id"
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        Swal.fire('Data berhasil dihapus!', '', 'success').then(async function () {
                            const deleteData = await newsPromotionServices.deleteNewsById(id, self.user.bearer)
