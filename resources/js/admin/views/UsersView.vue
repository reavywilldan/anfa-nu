                            ...
                            <div class="col-md-12 mb-lg-0 mb-4">
                                <div class="row">
                                    <div class="col-6 text-end">
                                        <a class="btn bg-gradient-dark mb-0" href="/admstr/add-users">
                            ...
                            <div class="card-body px-0 pt-0 pb-2">
                                <div class="table-responsive p-0">
                                    <table class="table align-items-center mb-0">
                                        ...
                                        <tbody>
                                            <tr v-for="usersData in users" :key="usersData.id" :id="usersData.id">
                                                ...
                                                <td class="align-middle">
                                                    <a href="#" class="text-secondary font-weight-bold text-xs"
                                                        data-toggle="tooltip" :data-id="usersData.id"
...
export default {
    ...
    methods: {
        async loadDataFromServer() {
            try {
                const result = await usersServices.getUsers(this.page, this.user.bearer)
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        Swal.fire('Data berhasil dihapus!', '', 'success').then(async function () {
                            const deleteData = await usersServices.deleteUsersById(id, self.user.bearer)
