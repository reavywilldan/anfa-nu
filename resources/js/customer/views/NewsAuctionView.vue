            ...
            <main id="main">
                <section id="more-services" class="more-services">
                    <div class="container">
                        ...
                        <TitlePageComponent msg="Berita Lelang" />
...
import newsAuctionServices from '../../services/newsAuction'


export default {
    name: 'NewsAuctionView',
    components: {
        HeaderComponent,
        FooterComponent,
        TitlePageComponent,
    ...
    methods: {
        async loadDataFromServer() {
            try {
                const result = await newsAuctionServices.getNews(this.page)
